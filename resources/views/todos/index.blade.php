    ...
    <table class="table table-striped table-dark m-3">
        ...
        <tbody>
            @foreach($todos as $todo)
                ...
                <td>
                <div class="d-flex">
                    <a class="btn btn-outline-info mr-2" data-toggle="modal" data-morning="{{$todo->morning}}" data-afternoon="{{$todo->afternoon}}" data-evening="{{$todo->evening}}" data-tomorrow="{{$todo->tomorrow}}" data-target="#EditModal" href="/edit/{{$todo->id}}" role="button">Edit</a>
